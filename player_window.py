...
class PlayerWindow(tk.Frame):
    ...
    def __init__(self, parent, my_controller):
        ...
        tk.Label(mid_frame, text='Current Song:').grid(row=0, column=0, sticky=tk.E, padx=5, pady=5)
        self._current_song = tk.Label(mid_frame, text='')
        self._current_song.grid(row=0, column=1, sticky=tk.W, padx=5, pady=5)
        tk.Label(mid_frame, text='Next Song:').grid(row=1, column=0, sticky=tk.E, padx=5, pady=5)
        self._next_song = tk.Label(mid_frame, text='')
        self._next_song.grid(row=1, column=1, sticky=tk.W, padx=5, pady=5)
        ...
        self.song_listbox.grid(row=1, column=3, padx=5, pady=5, sticky=tk.W + tk.E)
        self.song_scrollbar.grid(sticky=tk.N + tk.E + tk.S, row=0, column=3, padx=5, pady=5, columnspan=3, rowspan=3)
        ...
        self.add_button = tk.Button(bot_frame, text='Add Song', width=10, command=my_controller.add_callback)
